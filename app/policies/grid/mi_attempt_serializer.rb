...
class Grid::MiAttemptSerializer
  ...
  def as_json
    json_hash = super(@mi_attempt, @options) do |serialized_hash|
      serialized_hash['genotyped_confirmed_colony_names'] = genotyped_confirmed_colony_names
      serialized_hash['genotyped_confirmed_colony_phenotype_attempts_count'] = genotyped_confirmed_colony_phenotype_attempts_count
      serialized_hash['genotype_confirmed_allele_symbols'] = genotype_confirmed_allele_symbols
      serialized_hash['genotype_confirmed_distribution_centres'] = genotype_confirmed_distribution_centres
      serialized_hash['mi_plan_mutagenesis_via_crispr_cas9'] = mi_plan_mutagenesis_via_crispr_cas9
    end
