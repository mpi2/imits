...
module TarMits
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/lib #{config.root}/forms #{config.root}/policies #{config.root}/presenters #{config.root}/reports #{config.root}/services #{config.root}/values)
