...
CREATE TABLE intermediate_report (
    ...
    production_centre character varying(100) NOT NULL,
    ...
    allele_symbol character varying(75) NOT NULL,
    genetic_background character varying(50) NOT NULL,
    assigned_date date,
...
CREATE TABLE targ_rep_es_cells (
    ...
    parental_cell_line character varying(255),
    allele_symbol_superscript character varying(75),
    name character varying(100) NOT NULL,
    comment character varying(255),
    contact character varying(255),
...
CREATE UNIQUE INDEX mi_plan_logical_key ON mi_plans USING btree (gene_id, consortium_id, production_centre_id, sub_project_id);
...
--
-- Name: mi_attempt_status_stamps_mi_attempt_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mi_attempt_status_stamps
    ADD CONSTRAINT mi_attempt_status_stamps_mi_attempt_id_fk FOREIGN KEY (mi_attempt_id) REFERENCES mi_attempts(id);
...
--
-- Name: phenotype_attempts_mi_attempt_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY phenotype_attempts
    ADD CONSTRAINT phenotype_attempts_mi_attempt_id_fk FOREIGN KEY (mi_attempt_id) REFERENCES mi_attempts(id);
