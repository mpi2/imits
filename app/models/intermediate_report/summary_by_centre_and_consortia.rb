     ...
     def self.best_phenotyping_sql(crispr_condition = nil, excision__condition = nil, allele_type = nil)
        ...
        <<-EOF
          ...
          att AS (
            SELECT
              ...
              first_value(best_plans_for_gene_consortia_centre_and_status.plan_id) OVER (PARTITION BY best_plans_for_gene_consortia_centre_and_status.gene_id, best_plans_for_gene_consortia_centre_and_status.consortium_id, best_plans_for_gene_consortia_centre_and_status.production_centre_id) AS plan_id
      ...
      def self.columns
        [
          ...
          'es_cell_status',                              # es_cell_qc statuses
