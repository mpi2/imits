class SolrUpdate::Enqueuer
  def mi_attempt_updated(mi)
    ...
    if mi.has_status? :gtc and ! mi.has_status? :abt and mi.allele_id > 0 and mi.report_to_public and mi.consortium != "EUCOMMToolsCre"
  ...
  def phenotype_attempt_updated(pa)
    ...
    if pa.has_status? :cec and ! pa.has_status? :abt and pa.allele_id > 0 and pa.report_to_public and pa.consortium != "EUCOMMToolsCre"
      if pa.mi_attempt.has_status? :gtc and ! pa.mi_attempt.has_status? :abt and pa.mi_attempt.allele_id > 0 and pa.mi_attempt.report_to_public and pa.mi_attempt.consortium != "EUCOMMToolsCre"
