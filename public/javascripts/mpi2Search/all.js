...
(function ($) {
    ...
    MPI2.Search.GeneDoc = function (solrDoc, entireSolrResponse) {
        ...
        self.geneLink = '<a class="populate_allele_grid" data-marker_symbol="' + self.markerSymbol + '" data-id="' + self.mgiAccessionId + '" href="#">' + self.markerSymbol + '</a>';
...
(function ($) {
    ...
    $.widget("MPI2.mpi2GeneGridNew", $.MPI2.mpi2SolrGrid, {
            ...
            var options = [
                {
                    name: 'gene',
                    title: 'Gene',
                    cellRenderer: function (geneDoc) {return $(geneDoc.geneLink);}
                },
                {
                    name: 'latest-status',
                    title: 'Latest Status',
