    ...
    class << self
      ...
      def report_sql
        <<-EOF
          ...
          (
          SELECT mi_plans.gene_id AS gene_id, mi_plans.consortium_id AS consortium_id, mi_plans.production_centre_id AS production_centre_id, min(mi_plan_commence_date.mi_plan_date) AS commenece_date
            FROM mi_plans
