...
#
  context 'Gene' do
    ...
    context 'database table' do
      ...
      should have_db_column(:mgi_accession_id).of_type(:string).with_options(:limit => 40)
      should have_db_column(:ikmc_projects_count).of_type(:integer)
      should have_db_column(:conditional_es_cells_count).of_type(:integer)
      should have_db_column(:non_conditional_es_cells_count).of_type(:integer)
      should have_db_column(:deletion_es_cells_count).of_type(:integer)
      should have_db_column(:other_targeted_mice_count).of_type(:integer)
      should have_db_column(:other_condtional_mice_count).of_type(:integer)
      should have_db_column(:mutation_published_as_lethal_count).of_type(:integer)
      should have_db_column(:publications_for_gene_count).of_type(:integer)
      should have_db_column(:go_annotations_for_gene_count).of_type(:integer)
      should have_db_column(:created_at).of_type(:datetime)
      should have_db_column(:updated_at).of_type(:datetime)
      should have_db_column(:chr).of_type(:string).with_options(:limit => 2)
      should have_db_column(:start_coordinates).of_type(:integer)
      should have_db_column(:end_coordinates).of_type(:integer)
      should have_db_column(:strand_name).of_type(:string).with_options(:limit => 255)
      should have_db_column(:vega_ids).of_type(:string).with_options(:limit => 255)
      should have_db_column(:ncbi_ids).of_type(:string).with_options(:limit => 255)
      should have_db_column(:ensembl_ids).of_type(:string).with_options(:limit => 255)
      should have_db_column(:ccds_ids).of_type(:string).with_options(:limit => 255)
      should have_db_column(:marker_type).of_type(:string).with_options(:limit => 255)
      should have_db_column(:feature_type).of_type(:string).with_options(:limit => 255)
      should have_db_column(:synonyms).of_type(:string).with_options(:limit => 255)
      should have_db_column(:komp_repo_geneid).of_type(:integer)
      should have_db_column(:marker_name).of_type(:string).with_options(:limit => 255)
      should have_db_column(:cm_position).of_type(:string).with_options(:limit => 255)
      should have_db_column(:human_marker_symbol).of_type(:string).with_options(:limit => 255)
      should have_db_column(:human_entrez_gene_id).of_type(:string).with_options(:limit => 255)
      should have_db_column(:human_homolo_gene_id).of_type(:string).with_options(:limit => 255)

      should have_db_index(:marker_symbol).unique(true)
      should have_db_index(:mgi_accession_id).unique(true)
    end
    ...
    context 'Associations and Validations' do
      ...
      should have_many(:mi_attempts).through(:mi_plans)
      should have_many(:mouse_allele_mods).through(:mi_plans)
      should have_many(:phenotyping_productions).through(:mi_plans)
      should have_many :notifications
      should have_many(:contacts).through(:notifications)
    end
    ...
    context 'instance method' do
      context 'vectors' do
        should 'return targeting_vectors' do
    ...
    should 'not output private attributes in serialization' do
      gene_json = genes(:private_attributes).as_json.stringify_keys
