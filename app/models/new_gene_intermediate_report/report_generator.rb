    ...
    class << self
        ...
        <<-EOF
          ...
          best_phenotype_attempts AS (
            SELECT
              ...
              best_phenotype_attempts.phenotyping_experiments_started::date as phenotyping_experiments_started_date,
              ...
              JOIN (
                ...
                FROM (
                  SELECT
                    ...
                    FROM es_cell_plans
                    JOIN phenotype_attempts ON es_cell_plans.id = phenotype_attempts.mi_plan_id
            ...
            JOIN es_cell_plans ON es_cell_plans.id = best_phenotype_attempts.mi_plan_id
            ...
            LEFT JOIN es_cell_plans AS mi_attempt_mi_plans ON mi_attempt_mi_plans.id = mi_attempts.mi_plan_id
          ...
          best_cre_ex_phenotype_attempts AS (
            SELECT
              ...
              re_complete_statuses.created_at::date as rederivation_complete_date,
              cre_started_statuses.created_at::date as cre_excision_started_date,
              best_phenotype_attempts_cre_ex.phenotyping_experiments_started::date as phenotyping_experiments_started_date,
              cre_complete_statuses.created_at::date as cre_excision_complete_date,
              started_statuses.created_at::date as phenotyping_started_date,
              complete_statuses.created_at::date as phenotyping_complete_date,
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date,
            ...
            FROM (
              ...
              JOIN (
                SELECT
                  ...
                  best_attempts_for_plan_and_status_cre_ex.production_centre_id,
                  best_attempts_for_plan_and_status_cre_ex.order_by,
                  first_value(best_attempts_for_plan_and_status_cre_ex.phenotype_attempt_id) OVER (PARTITION BY best_attempts_for_plan_and_status_cre_ex.gene_id, best_attempts_for_plan_and_status_cre_ex.consortium_id, best_attempts_for_plan_and_status_cre_ex.production_centre_id) AS phenotype_attempt_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
            ...
            JOIN es_cell_plans ON es_cell_plans.id = best_phenotype_attempts_cre_ex.mi_plan_id
          ...
          best_non_cre_ex_phenotype_attempts AS (
            SELECT
              ...
              cre_complete_statuses.created_at::date as cre_excision_complete_date,
              started_statuses.created_at::date as phenotyping_started_date,
              best_phenotype_attempts_non_cre_ex.phenotyping_experiments_started::date as phenotyping_experiments_started_date,
              complete_statuses.created_at::date as phenotyping_complete_date,
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date,
            ...
            FROM (
              ...
              JOIN (
                SELECT
                  ...
                  best_attempts_for_plan_and_status_non_cre_ex.production_centre_id,
                  best_attempts_for_plan_and_status_non_cre_ex.order_by,
                  first_value(best_attempts_for_plan_and_status_non_cre_ex.phenotype_attempt_id) OVER (PARTITION BY best_attempts_for_plan_and_status_non_cre_ex.gene_id, best_attempts_for_plan_and_status_non_cre_ex.consortium_id, best_attempts_for_plan_and_status_non_cre_ex.production_centre_id) AS phenotype_attempt_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
            ...
            JOIN es_cell_plans ON es_cell_plans.id = best_phenotype_attempts_non_cre_ex.mi_plan_id
          ...
          best_mi_attempts_by_consortia AS (
            ...
            JOIN es_cell_plans ON es_cell_plans.id = best_mi_attempts_by_consortia.mi_plan_id
          ...
          best_phenotype_attempts_by_consortia AS (
            ...
            JOIN es_cell_plans ON es_cell_plans.id = best_phenotype_attempts_by_consortia.mi_plan_id
            LEFT JOIN consortia ON consortia.id = es_cell_plans.consortium_id
            ORDER BY es_cell_plans.gene_id, es_cell_plans.consortium_id
          ),
          ...
          SELECT
            ...
            best_phenotype_attempts.phenotype_attempt_id AS phenotype_attempt_id,
            ...
            best_phenotype_attempts.phenotyping_experiments_started_date,
            ...
            best_non_cre_ex_phenotype_attempts.phenotyping_experiments_started_date AS non_cre_ex_phenotyping_experiments_started_date,
            ...
            best_cre_ex_phenotype_attempts.phenotyping_experiments_started_date AS cre_ex_phenotyping_experiments_started_date,
          ...
          LEFT JOIN best_non_cre_ex_phenotype_attempts ON best_non_cre_ex_phenotype_attempts.gene_id = unique_gene_plans.gene_id AND best_non_cre_ex_phenotype_attempts.consortium_id = unique_gene_plans.consortium_id AND  best_non_cre_ex_phenotype_attempts.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_cre_ex_phenotype_attempts ON best_cre_ex_phenotype_attempts.gene_id = unique_gene_plans.gene_id AND best_cre_ex_phenotype_attempts.consortium_id = unique_gene_plans.consortium_id AND  best_cre_ex_phenotype_attempts.production_centre_id = unique_gene_plans.production_centre_id
      ...
      def gene_efficiency_sql
        <<-EOF
          ...
          counts AS (
            ...
            JOIN mi_attempts ON targ_rep_es_cells.id = mi_attempts.es_cell_id
            JOIN es_cell_plans ON es_cell_plans.id = mi_attempts.mi_plan_id
            JOIN consortia ON consortia.id = es_cell_plans.consortium_id
            JOIN mi_attempt_status_stamps ON mi_attempts.id = mi_attempt_status_stamps.mi_attempt_id AND mi_attempt_status_stamps.status_id = 1
            LEFT JOIN centres ON centres.id = es_cell_plans.production_centre_id

            GROUP BY genes.id, es_cell_plans.consortium_id, es_cell_plans.production_centre_id
            ORDER BY genes.id, es_cell_plans.consortium_id, es_cell_plans.production_centre_id
          )
      ...
      def columns
        [
          ...
          'non_cre_ex_phenotyping_experiments_started_date',
          ...
          'cre_ex_phenotyping_experiments_started_date',
