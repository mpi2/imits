    ...
    class << self
        ...
        <<-EOF
          ...
          best_phenotype_attempts AS (
            SELECT
              ...
              best_phenotype_attempts.phenotyping_experiments_started::date as phenotyping_data_flow_started_date,
          ...
          best_cre_ex_phenotype_attempts AS (
            SELECT
              ...
              re_complete_statuses.created_at::date as rederivation_complete_date,
              cre_started_statuses.created_at::date as cre_excision_started_date,
              best_phenotype_attempts_cre_ex.phenotyping_experiments_started::date as phenotyping_data_flow_started_date,
              cre_complete_statuses.created_at::date as cre_excision_complete_date,
              started_statuses.created_at::date as phenotyping_started_date,
              complete_statuses.created_at::date as phenotyping_complete_date,
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date,
          ...
          best_non_cre_ex_phenotype_attempts AS (
            SELECT
              ...
              cre_complete_statuses.created_at::date as cre_excision_complete_date,
              started_statuses.created_at::date as phenotyping_started_date,
              best_phenotype_attempts_non_cre_ex.phenotyping_experiments_started::date as phenotyping_data_flow_started_date,
              complete_statuses.created_at::date as phenotyping_complete_date,
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date,
          ...
          SELECT
            ...
            best_phenotype_attempts.phenotyping_data_flow_started_date,
            ...
            best_non_cre_ex_phenotype_attempts.phenotyping_data_flow_started_date AS non_cre_ex_phenotyping_data_flow_started_date,
            ...
            best_cre_ex_phenotype_attempts.phenotyping_data_flow_started_date AS cre_ex_phenotyping_data_flow_started_date,
      ...
      def columns
        [
          ...
          'phenotyping_data_flow_started_date',
          ...
          'non_cre_ex_phenotyping_data_flow_started_date',
          ...
          'cre_ex_phenotyping_data_flow_started_date',
