class NewIntermediateReportSummaryByConsortia < ActiveRecord::Base
  ...
  self.table_name = :new_intermediate_report_summary_by_consortia

  include NewIntermediateReportSummaryByConsortia::ReportGenerator
...
# == Schema Information
#
# Table name: new_intermediate_report_summary_by_consortia
#
