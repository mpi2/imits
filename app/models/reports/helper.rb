...
module Reports::Helper
    ...
    def generate_mi_list_report( params={} )
      report_column_order_and_names = {
        ...
        'mi_attempts.es_cell.pipeline.name'                           => 'ES Cell Pipeline',
        'mi_attempts.es_cell.name'                                    => 'Clone Name',
        'mi_attempts.es_cell.parental_cell_line'                      => 'ES Cell Parental Cell Line',
        'gene.mgi_accession_id'                                       => 'MGI Accession ID',
        'gene.marker_symbol'                                          => 'Marker Symbol',
        'mi_attempts.es_cell.allele_symbol'                           => 'Clone Allele Name',
        'mi_attempts.mi_date'                                         => 'Injection Date',
        'mi_attempts.status.name'                                     => 'Status',
        'mi_attempts.colony_background_strain.name'                   => 'Background Strain',
        'mi_attempts.blast_strain.name'                               => 'Blastocyst Strain',
        ...
        'mi_attempts.test_cross_strain.name'                          => 'Test Cross Strain',
