module NewIntermediateReportSummaryByConsortia::ReportGenerator
  class Generate
    ...
    def to_s
      "#<NewIntermediateReportSummaryByConsortia::Generate size: #{size}>"
    end
    ...
    def insert_report
      begin
        sql =  <<-EOF
          ...
          TRUNCATE new_intermediate_report_summary_by_consortia;

          INSERT INTO new_intermediate_report_summary_by_consortia (#{self.class.columns.join(', ')}) VALUES
        EOF
        ...
        <<-EOF
          ...
          best_overall_mouse_allele_modification AS (
            ...
            FROM (
              ...
              SELECT DISTINCT attempts_join.gene_id, attempts_join.consortium_id, mouse_allele_mods.*
          ...
          best_overall_phenotyping_production_by_allele AS (
            SELECT
              ...
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date
            FROM (
              SELECT DISTINCT production_join.gene_id, production_join.consortium_id, phenotyping_productions.*
          ...
          best_mouse_allele_modification AS (
            ...
            ORDER BY best_mouse_allele_mods.gene_id, best_mouse_allele_mods.consortium_id
          ),
          ...
          phenotyping_production_by_allele AS (
            SELECT
              ...
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date
            FROM (
              SELECT DISTINCT production_join.gene_id ,production_join.consortium_id, phenotyping_productions.*, production_join.allele_category
              FROM phenotyping_productions
              JOIN (
                SELECT
                  phenotype_production_ordered_by_allele_and_status.gene_id,
            ...
            ORDER BY best_phenotyping_production_by_allele.gene_id, best_phenotyping_production_by_allele.consortium_id
          ),
          ...
          LEFT JOIN best_overall_phenotyping_production_by_allele ON best_overall_phenotyping_production_by_allele.gene_id = unique_gene_plans.gene_id AND best_overall_phenotyping_production_by_allele.consortium_id = unique_gene_plans.consortium_id
          LEFT JOIN best_phenotyping_production_for_tm1b ON best_phenotyping_production_for_tm1b.gene_id = unique_gene_plans.gene_id AND best_phenotyping_production_for_tm1b.consortium_id = unique_gene_plans.consortium_id
          ...
          LEFT JOIN best_mouse_allele_mod_for_tm1a ON best_mouse_allele_mod_for_tm1a.gene_id = unique_gene_plans.gene_id AND best_mouse_allele_mod_for_tm1a.consortium_id = unique_gene_plans.consortium_id
          LEFT JOIN best_mouse_allele_mod_for_tm1b ON best_mouse_allele_mod_for_tm1b.gene_id = unique_gene_plans.gene_id AND best_mouse_allele_mod_for_tm1b.consortium_id = unique_gene_plans.consortium_id
