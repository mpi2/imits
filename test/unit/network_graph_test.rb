  ...
  context 'NetworkGraph' do
    ...
    should 'produce dot file' do
      ...
      expected = "digraph \"Production Graph\"{rankdir=\"LR\";\n" +
                 ...
                 "\"P2\" [shape=none, margin=0, fontsize=10, label=<<table><tr><td colspan=\"2\">Mi Plan</td></tr><tr><td>Consortium:</td><td>BaSH</td></tr><tr><td>Centre:</td><td>WTSI</td></tr><tr><td>Assigned:</td><td></td></tr></table>>];\n" +
