...
require 'database_cleaner'  # NOT NEEDED I THINK functionality is covered by use_transactional_fixtures
require 'shoulda'
...
class ActiveSupport::TestCase
  ...
  self.use_transactional_fixtures = false  ## loads fixture data before every test and does not wrap each test in a tranaction.

  def database_strategy; :transaction; end

  def setup
    DatabaseCleaner.strategy = self.database_strategy  # NOT NEEDED I THINK functionality is covered by use_transactional_fixtures
    DatabaseCleaner.start  # NOT NEEDED I THINK functionality is covered by use_transactional_fixtures
    Test::Person.destroy_all
  end

  def teardown
    DatabaseCleaner.clean  # NOT NEEDED I THINK functionality is covered by use_transactional_fixtures
  end
