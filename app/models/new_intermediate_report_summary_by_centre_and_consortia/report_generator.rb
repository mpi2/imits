module NewIntermediateReportSummaryByCentreAndConsortia::ReportGenerator
  class Generate
    ...
    def to_s
      "#<NewIntermediateReportSummaryByCentreAndConsortia::Generate size: #{size}>"
    end
    ...
    def insert_report
      begin
        sql =  <<-EOF
          ...
          TRUNCATE new_intermediate_report_summary_by_centre_and_consortia;

          INSERT INTO new_intermediate_report_summary_by_centre_and_consortia (#{self.class.columns.join(', ')}) VALUES
        EOF
        ...
        <<-EOF
          ...
          best_mi_attempts AS (
            SELECT
              ...
              es_cell_plans.production_centre_id AS production_centre_id,
              ...
              JOIN (
                ...
                FROM (
                  SELECT
                    ...
                    es_cell_plans.production_centre_id,
          ...
          -- get the best_overall_mouse allele modification
          best_overall_mouse_allele_modification AS (
            SELECT
              ...
              best_mouse_allele_mods.production_centre_id,
              ...
              mi_attempts.external_ref AS pa_mi_attempt_colony_name,
            ...
            FROM (
              ...
              SELECT DISTINCT attempts_join.gene_id, attempts_join.consortium_id, attempts_join.production_centre_id, mouse_allele_mods.*
              FROM mouse_allele_mods
              JOIN (
                SELECT
                  best_allele_mod_for_plan_and_status.gene_id,
                  best_allele_mod_for_plan_and_status.consortium_id,
                  best_allele_mod_for_plan_and_status.production_centre_id,
                  best_allele_mod_for_plan_and_status.order_by,
                  first_value(best_allele_mod_for_plan_and_status.mouse_allele_mod_id)
                    OVER (PARTITION BY best_allele_mod_for_plan_and_status.gene_id, best_allele_mod_for_plan_and_status.consortium_id, best_allele_mod_for_plan_and_status.production_centre_id) AS mouse_allele_mod_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
            ...
            LEFT JOIN centres ON centres.id = es_cell_plans.production_centre_id
          ...
          -- get the best overall_phenotyping_production
          best_overall_phenotyping_production_by_allele AS (
            SELECT
              best_phenotyping_production_by_allele.gene_id,
              best_phenotyping_production_by_allele.consortium_id,
              best_phenotyping_production_by_allele.production_centre_id,
            ...
            FROM (
              SELECT DISTINCT production_join.gene_id, production_join.consortium_id, production_join.production_centre_id, phenotyping_productions.*
              FROM phenotyping_productions
              JOIN (
                SELECT
                  phenotype_production_ordered_by_allele_and_status.gene_id,
                  phenotype_production_ordered_by_allele_and_status.consortium_id,
                  phenotype_production_ordered_by_allele_and_status.production_centre_id,
                  ...
                  first_value(phenotype_production_ordered_by_allele_and_status.phenotype_productions_id) OVER
                    (PARTITION BY phenotype_production_ordered_by_allele_and_status.gene_id, phenotype_production_ordered_by_allele_and_status.consortium_id, phenotype_production_ordered_by_allele_and_status.production_centre_id) AS phenotyping_production_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
          ...
          best_mouse_allele_modification AS (
            ...
            FROM (
              ...
              JOIN (
                SELECT
                  ...
                  best_allele_mod_for_plan_and_status.order_by,
                  first_value(best_allele_mod_for_plan_and_status.mouse_allele_mod_id)
                    OVER (PARTITION BY best_allele_mod_for_plan_and_status.gene_id, best_allele_mod_for_plan_and_status.consortium_id,best_allele_mod_for_plan_and_status.production_centre_id, best_allele_mod_for_plan_and_status.allele_category) AS mouse_allele_mod_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
            ...
            ORDER BY best_mouse_allele_mods.gene_id, best_mouse_allele_mods.consortium_id, best_mouse_allele_mods.production_centre_id
          ),
          ...
          phenotyping_production_by_allele AS (
            SELECT
              ...
              aborted_statuses.created_at::date as phenotype_attempt_aborted_date
            FROM (
              SELECT DISTINCT production_join.gene_id ,production_join.consortium_id, production_join.production_centre_id, phenotyping_productions.*, production_join.allele_category
              FROM phenotyping_productions
              JOIN (
                SELECT
                  phenotype_production_ordered_by_allele_and_status.gene_id,
                  ...
                  phenotype_production_ordered_by_allele_and_status.order_by,
                  first_value(phenotype_production_ordered_by_allele_and_status.phenotype_productions_id) OVER
                    (PARTITION BY phenotype_production_ordered_by_allele_and_status.gene_id, phenotype_production_ordered_by_allele_and_status.consortium_id, phenotype_production_ordered_by_allele_and_status.production_centre_id, phenotype_production_ordered_by_allele_and_status.allele_category) AS phenotyping_production_id
                FROM (
                  SELECT
                    es_cell_plans.gene_id,
                    es_cell_plans.consortium_id,
            ...
            ORDER BY best_phenotyping_production_by_allele.gene_id, best_phenotyping_production_by_allele.consortium_id, best_phenotyping_production_by_allele.production_centre_id
          ),
          ...
          (
          SELECT es_cell_plans.gene_id AS gene_id, es_cell_plans.consortium_id AS consortium_id, es_cell_plans.production_centre_id AS production_centre_id, min(mi_plan_commence_date.mi_plan_date) AS commenece_date
            FROM es_cell_plans
          ...
          GROUP BY es_cell_plans.gene_id, es_cell_plans.consortium_id, es_cell_plans.production_centre_id
          )
          ...
          SELECT
            ...
            best_overall_phenotyping_production_by_allele.phenotyping_production_id,
            ...
            best_mi_attempts.mi_attempt_colony_name mi_attempt_colony_name,
            ...
            best_phenotyping_production_for_tm1a.phenotype_attempt_colony_name AS tm1b_phenotyping_production_colony_name,
          ...
          FROM (SELECT DISTINCT es_cell_plans.gene_id, es_cell_plans.consortium_id, es_cell_plans.production_centre_id FROM es_cell_plans) AS unique_gene_plans
          ...
          LEFT JOIN best_overall_mouse_allele_modification ON best_overall_mouse_allele_modification.gene_id = unique_gene_plans.gene_id AND best_overall_mouse_allele_modification.consortium_id = unique_gene_plans.consortium_id AND  best_overall_mouse_allele_modification.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_overall_phenotyping_production_by_allele ON best_overall_phenotyping_production_by_allele.gene_id = unique_gene_plans.gene_id AND best_overall_phenotyping_production_by_allele.consortium_id = unique_gene_plans.consortium_id AND  best_overall_phenotyping_production_by_allele.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_phenotyping_production_for_tm1b ON best_phenotyping_production_for_tm1b.gene_id = unique_gene_plans.gene_id AND best_phenotyping_production_for_tm1b.consortium_id = unique_gene_plans.consortium_id AND  best_phenotyping_production_for_tm1b.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_phenotyping_production_for_tm1a ON best_phenotyping_production_for_tm1a.gene_id = unique_gene_plans.gene_id AND best_phenotyping_production_for_tm1a.consortium_id = unique_gene_plans.consortium_id AND  best_phenotyping_production_for_tm1a.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_mouse_allele_mod_for_tm1a ON best_mouse_allele_mod_for_tm1a.gene_id = unique_gene_plans.gene_id AND best_mouse_allele_mod_for_tm1a.consortium_id = unique_gene_plans.consortium_id AND  best_mouse_allele_mod_for_tm1a.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN best_mouse_allele_mod_for_tm1b ON best_mouse_allele_mod_for_tm1b.gene_id = unique_gene_plans.gene_id AND best_mouse_allele_mod_for_tm1b.consortium_id = unique_gene_plans.consortium_id AND  best_mouse_allele_mod_for_tm1b.production_centre_id = unique_gene_plans.production_centre_id
          LEFT JOIN gene_interest_commenced ON gene_interest_commenced.gene_id = unique_gene_plans.gene_id AND gene_interest_commenced.consortium_id = unique_gene_plans.consortium_id AND gene_interest_commenced.production_centre_id =unique_gene_plans.production_centre_id
