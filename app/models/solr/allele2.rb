class Solr::Allele2 < Solr::Tableless
  attr_accessor :type, :allele_design_project, 
                ...
                :allele_symbol, :allele_name, :allele_type, :allele_subtype, :allele_mgi_accession_id, :mgi_accession_id, :synonym, :allele_symbol_search_variants,
                :allele_description, :full_allele_description, :design_id, :cassette, :ikmc_project, :pipeline,
                ...
                :sequence_files_urls, :vcf_file_urls, :bam_file_urls, :genoverse_design_track_url, :genoverse_mut_allele_track_url, :genoverse_predicted_allele_track_url, :links,
                :es_cell_status, :mouse_status, :phenotype_status, :late_adult_phenotype_status,
                :conditional_mouse_status, :deletion_mouse_status, :disease_model_status,
