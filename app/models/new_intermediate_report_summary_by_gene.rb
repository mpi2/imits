class NewIntermediateReportSummaryByGene < ActiveRecord::Base
  attr_accessible(
    'mi_plan_id',
    'mi_attempt_id',
    'mouse_allele_mod_id',
  ...
  self.table_name = :new_intermediate_report_summary_by_gene

  include NewIntermediateReportSummaryByGene::ReportGenerator
...
# == Schema Information
#
# Table name: new_intermediate_report_summary_by_gene
#
